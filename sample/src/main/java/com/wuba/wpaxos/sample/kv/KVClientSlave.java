...
public class KVClientSlave {
	...
	public static void main(String[] args) throws Exception {
		...
		Configurator.initialize(KVClientSlave.class.getClassLoader(), src);
		logger = LogManager.getLogger(KVClientSlave.class);
		...
		fileServer.runPaxos();
		logger.info("paxos slave run success!");
	}
